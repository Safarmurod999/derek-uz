  ...
  resources: {
    en: {
      translation: {
        ...
        ascending_price: "Order: Ascending price",
        descending_price: "Order: Descending price",
    ...
    ru: {
      translation: {
        ...
        buy: "Купить",
        add_cart: "В корзину",
        ascending_price: "Порядок: По возрастанию цены",
        descending_price: "Порядок: По убыванию цены",
