...
const Header = () => {
  ...
  return (
    <header className={`header`}>
      <nav className="header__nav">
        <div className={`container ${!show && 'shrink'}`}>
          ...
          <div className={`header__menu ${openNavbar ? 'open' : ''}`}>
            ...
            <div className="header__menu--item menu--item" onClick={() => setIsModalOpen(true)}>
              <p>Корзина</p>
            </div>
          ...
          <div className="header__actions">
            ...
            <button className="header__actions--button header__actions--item"  onClick={() => setIsModalOpen(true)}>
      ...
      <Cart isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} quantity={quantity} setQuantity={setQuantity} />
    </header>
  )
}
